...
import { BarChart3, Plus, Search, Filter, ArrowRight, Check, X, Trash2 } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 items-start">
            {stages.map((stage) => {
              ...
              return (
                <div key={stage} className="bg-sky-50/20 border border-sky-100 rounded-3xl p-3.5 space-y-3">
                      ...
                      return (
                        ...
                        >
                          <div className="flex justify-between items-start gap-2">
                            <h4 className="text-xs font-bold text-sky-600 leading-snug">{l.name}</h4>
                            {role === "admin" && (
                              <button
                          ...
                          <div className="text-[10px] text-sky-400 font-bold uppercase">{l.business}</div>
                          <div className="text-[9px] text-sky-400 truncate">{l.contactInfo}</div>

                          <div className="pt-2 border-t border-sky-50 space-y-2">
                            <div className="flex items-center justify-between">
                              <span className="text-[9px] text-sky-400 font-medium">Follow: {l.followUpDate || "None"}</span>
                              <select
                                value={l.status}
                            ...
                            {!isConverted && (
                              <button
                                ...
                                className="w-full py-1.5 bg-sky-500 hover:bg-sky-600 text-white rounded-lg text-[9px] font-bold shadow flex items-center justify-center gap-1"
                              >
                            ...
                            {isConverted && (
                              <div className="py-1 bg-sky-50 border border-sky-150 text-sky-600 text-center rounded text-[9px] font-bold flex items-center justify-center gap-1">
